...
export default class InventoryVoucher extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllInventoryVouchers();
  }
  ...
  public retrieveAllInventoryVouchers(): void {
  ...
  public prepareRemove(instance: IInventoryVoucher): void {
  ...
  public removeInventoryVoucher(): void {
    this.inventoryVoucherService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('smartproApp.inventoryVoucher.deleted', { param: this.removeId });
