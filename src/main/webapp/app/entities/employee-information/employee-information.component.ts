...
export default class EmployeeInformation extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllEmployeeInformations();
  }
  ...
  public retrieveAllEmployeeInformations(): void {
  ...
  public prepareRemove(instance: IEmployeeInformation): void {
  ...
  public removeEmployeeInformation(): void {
    this.employeeInformationService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('smartproApp.employeeInformation.deleted', { param: this.removeId });
