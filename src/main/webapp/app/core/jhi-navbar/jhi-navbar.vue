        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/employee-information">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.employeeInformation')">EmployeeInformation</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/employee-salary">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.employeeSalary')">EmployeeSalary</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/employee">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.employee')">Employee</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/payroll-generate">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.payrollGenerate')">PayrollGenerate</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/accounting-voucher">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.accountingVoucher')">AccountingVoucher</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/sales-voucher-type">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.salesVoucherType')">SalesVoucherType</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/sales-voucher-type-total">
                        <font-awesome-icon icon="asterisk" />
