...
/**
 * REST controller for managing {@link com.rubic.smartpro.domain.ProductItem}.
 */
@RestController
@RequestMapping("/api")
public class ProductItemResource {
    ...
    public ResponseEntity<ProductItemDTO> createProductItem(@Valid @RequestBody ProductItemDTO productItemDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ProductItemDTO> updateProductItem(@Valid @RequestBody ProductItemDTO productItemDTO) throws URISyntaxException {
