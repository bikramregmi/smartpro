...
/**
 * REST controller for managing {@link com.rubic.smartpro.domain.Group}.
 */
@RestController
@RequestMapping("/api")
public class GroupResource {
    ...
    /**
     * {@code POST  /group} : Create a new group.
     *
    ...
    /**
     * {@code PUT  /group} : Updates an existing group.
     *
    ...
    /**
     * {@code GET  /group} : get all the groups.
     *
    ...
    /**
     * {@code GET  /group/:id} : get the "id" group.
     *
    ...
    /**
     * {@code DELETE  /group/:id} : delete the "id" group.
     *
