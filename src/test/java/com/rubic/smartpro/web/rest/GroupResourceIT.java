...
public class GroupResourceIT {
    ...
    private static final Boolean DEFAULT_OPTION = false;
    private static final Boolean UPDATED_OPTION = true;
    ...
    public void createGroup() throws Exception {
        ...
        assertThat(testGroup.isOption()).isEqualTo(DEFAULT_OPTION);
    }
    ...
    public void getAllGroups() throws Exception {
        ...
        restGroupMockMvc.perform(get("/api/groups?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].option").value(hasItem(DEFAULT_OPTION.booleanValue())));
    }
    ...
    public void getGroup() throws Exception {
        ...
        restGroupMockMvc.perform(get("/api/groups/{id}", group.getId()))
            ...
            .andExpect(jsonPath("$.option").value(DEFAULT_OPTION.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateGroup() throws Exception {
        ...
        assertThat(testGroup.isOption()).isEqualTo(UPDATED_OPTION);
    }
