...
import AttendanceComponent from '@/entities/attendance/attendance.vue';
import AttendanceClass from '@/entities/attendance/attendance.component';
...
describe('Component Tests', () => {
  describe('Attendance Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<AttendanceClass>(AttendanceComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(attendanceServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(attendanceServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
